...
import './Hackathonct.css'

function Hackathonct() {
  ...
  const addHackathon = [["Title", "text"], ["Body", "text"], ["Tags", "text"], ["Company", "text"], ["Video", "text"]]
