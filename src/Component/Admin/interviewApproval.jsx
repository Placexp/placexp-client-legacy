...
function interviewApproval() {
  return (
    <div class="container">
      <Jumbotron>
        <h1 class="display-4">Interview Approval</h1>
        <br />
        ...
        <tbody>
          <tr>
            ...
            <td data-label="Interview">Amazon</td>
          ...
          <tr>
            ...
            <td data-label="Interview">Google</td>
          ...
          <tr>
            ...
            <td data-label="Interview">Microsoft</td>
          ...
          <tr>
            ...
            <td data-label="Interview">Schlumberger</td>
          ...
          <tr>
            ...
            <td data-label="Interview">Tesla</td>
