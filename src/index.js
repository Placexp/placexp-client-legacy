...
const ViewContacts = React.lazy(() => import("./Pages/ViewContacts"));
const Root = () => {
        ...
        <Context.Provider value={{ State, dispatch }}>
          <Switch>
            ...
            <ProtectedRoute
              ...
              component={withRouter(Interviewct)}
            />
            <Route path="/interview/:id" component={withRouter(Interviewsp)} />
            <ProtectedRoute
              path="/interview_edit/:id"
              component={withRouter(Interviewed)}
            />
            <Route path="/interview" component={withRouter(Interview)} />
            <ProtectedRoute
              path="/verifyinterview"
              component={withRouter(InterviewApprove)}
            />
            <ProtectedRoute
              path="/viewcontacts"
              component={withRouter(ViewContacts)}
            />
            <Route
              path="/logout"
